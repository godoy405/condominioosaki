            ...
            <?php echo form_open(
                    ...
                    hidden: $hidden ?? []
                        ...
                        <div class="mb-3">
                          ...
                          <input type="email" class = "form-control" name = "email" value = "<?php echo old('name', $resident?->user?->email); ?>"id="email" placeholder="E-mail de acesso" />
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password_confirm" class = "form-control" name = "password_confirm" id="password_confirm" placeholder="Confirme a senha" />
                        </div>
